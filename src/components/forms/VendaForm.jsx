...
export default function VendaForm({ open, onOpenChange, venda, onSubmit, isLoading, currentUser }) {
  ...
  const handleTaxaChange = (e) => {
    const valorFormatado = formatarPercentual(e.target.value);
              ...
              <div>
                ...
                <div className="relative">
                  <Input
                    ...
                    value={watch('taxaAdministracao') ? formatarPercentual((parseFloat(watch('taxaAdministracao')) * 100).toString()) : ''}
