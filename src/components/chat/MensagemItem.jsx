        ...
        return (
          <div>
            ...
            {imagemAberta && mediaUrl && (
              <div
                className="absolute inset-0 bg-black/90 flex items-center justify-center z-[9999] p-4"
  ...
  if (isImagemLimpa) {
    ...
    return (
      <div data-msg-whatsapp-id={mensagem.whatsapp_message_id || undefined} className={`flex ${isVendedor ? 'justify-end' : 'justify-start'} gap-2 group animate-in fade-in slide-in-from-bottom-2 duration-300 rounded-lg transition-shadow`}>
        ...
        {imagemAberta && mediaUrl && (
          <div className="absolute inset-0 bg-black/90 flex items-center justify-center z-[9999] p-4" onClick={() => setImagemAberta(false)}>
