...
export default function ColaboracaoInterna({ tarefa, currentUser, colaboradores = [], onUpdate }) {
  ...
  return (
    <div className="flex flex-col overflow-hidden flex-1" style={{ minHeight: '400px' }}>
      {/* Área principal: Timeline + Input */}
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">

        {/* Timeline - Mobile com padding reduzido */}
        <div className="flex-1 overflow-y-auto px-4 py-3 md:px-5 md:py-4 space-y-3 md:space-y-4 bg-slate-50">
          {isLoading && (
        ...
        {/* Input area - Mobile com padding reduzido */}
        <div className="border-t bg-white px-3 py-2 md:px-4 md:py-3 flex-shrink-0">
