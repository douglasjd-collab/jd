    ...
    <>
      ...
      {!aberto && naoLidos > 0 && (
        <button
          ...
          className="fixed bottom-6 left-6 z-[9998] bg-[#1e3a5f] text-white rounded-full w-12 h-12 flex items-center justify-center shadow-lg hover:bg-[#2a4a73] transition-colors"
        >
          <Bell className="w-5 h-5" />
