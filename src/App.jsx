...
import GerenciadorAssinaturas from './pages/GerenciadorAssinaturas';
...
const AuthenticatedApp = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/GerenciadorAssinaturas" element={<LayoutWrapper currentPageName="GerenciadorAssinaturas"><GerenciadorAssinaturas /></LayoutWrapper>} />
