...
import { Search, Settings, AlertTriangle, Clock3, CheckCircle2, UserSquare2, LayoutGrid } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-6 gap-3">
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              size="sm"
              className={mostrarSoMinhas ? 'bg-[#1e3a5f] text-white h-9 px-3 whitespace-nowrap' : 'h-9 px-3 whitespace-nowrap'}
              onClick={() => setMostrarSoMinhas(p => !p)}
              title="Mostrar só minhas tarefas"
            >
              Minhas
            </Button>
          </div>
