  ...
  useEffect(() => {
    ...
    if (!conversaSelecionada) {
      ...
      if (conversaAtualizada) {
        ...
        setConversaSelecionada(prev => prev ? { ...prev, status: conversaAtualizada.status, ultima_mensagem: conversaAtualizada.ultima_mensagem, data_ultima_mensagem: conversaAtualizada.data_ultima_mensagem, tipo_conexao: conversaAtualizada.tipo_conexao, instancia: conversaAtualizada.instancia, phone_number_id_meta: conversaAtualizada.phone_number_id_meta, canal_atendimento: conversaAtualizada.canal_atendimento, canal_preferencial: conversaAtualizada.canal_preferencial } : prev);
      } else {
